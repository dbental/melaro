...
export function SocialProof() {
  return (
    <section className="py-16 px-8 text-center border-t border-b border-card-border">
      <p className="text-[0.78rem] text-fg-dim font-medium uppercase tracking-[0.14em] mb-8">
